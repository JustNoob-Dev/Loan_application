                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="loana" id="loan amount" placeholder=" ----- Enter Amount ₱2,500 below ----" >
                                            ...
                                            <div class="col-sm-6">
                                             ...
                                             <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="email" name="email" disabled value="<?php echo $_SESSION['email']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="city" value="City of Baccor" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="city" value="Philippines" disabled>
                                                </select>
                                                </div>
                                            </div>

...
if(!empty($_POST['loana']) && !empty($_POST['payment'])) {
	...
	$result = $conn->query($sql);      
        ...
        echo "You have Existing loan application";
    }
   ?>
...
<form role="form" method="POST" action="blapply2.php">
...
<!--onlcick na script baka makalimutan mo pa!  yan try ko lng dito alam mo ba ginagawa ng script n yan ? riderection lng ano bayan d palam-->                  
                       ...
                       <script>
    function done() {
        window.location.href = "smallbusinessloan.php";
    }
</script>
 ...
 <?php } else { 
    ...
    "</script>";
               ...
               echo "Required All inputs field";

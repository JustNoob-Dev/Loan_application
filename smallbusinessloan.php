...
<div class="ccontainer">
    <div class="row">
      ...
      <h1>Small Scale Business Loan</h1>
...
<form role="form" method="POST" action="blapply.php">
...
<div class="tab-pane active" role="tabpanel" id="step1">
    ...
    <p>Fill Up</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" onkeypress="return alpha(event,numbers)" class="form-control"  name="loana" id="loan amount" placeholder="<?php
                                                    if($x['account_lvl']==3){
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  onkeypress="return alpha(event,letters)" class="form-control" id="firstname"
                                                     value="<?php echo $_SESSION['username'] ?>" disabled name="fullname">
                                                </div>
                                            </div>
                                             <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="company">Email Address</label>
                                                    <input type="email" class="form-control" id="email" disabled name="email" value="<?php echo $_SESSION['email']; ?>">
                                                </div>
                                            </div>
                                               <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="firstname">Business Name</label>
                                                    <input type="text"  onkeypress="return alpha(event,numbers+letters)" class="form-control"  name="bname">
                                                </div>
                                            </div>
                                                  <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label for="firstname">Business Address</label>
                                                    <input type="text"  onkeypress="return alpha(event,numbers+letters)" class="form-control" 
                                                     name="badd">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="address" value="<?php echo $x['address']?>" id="address">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" onkeypress="return alpha(event,numbers)" class="form-control" id="phone" name="contact" value="<?php echo $x['contact']?>" maxlength="11">
                                                </div>
            ...
            <ul class="list-inline pull-right">
               <li><button type="button" id="g" class="btn btn-success" onclick="home()">
